        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Вы успешно вошли в свой аккаунт');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Ошибка выхода, попробуйте позже');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            res = _context.sent;
            type === 'data' ? (0, _alerts.showAlert)('success', 'Данные успешно обновились') : (0, _alerts.showAlert)('success', 'Пароль успешно обновлён');
            _context.next = 11;
            break;
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"addProject.js":[function(require,module,exports) {
"use strict";
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"addFace.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.addFace = void 0;
...
var _addProject = require("./addProject");

var _addFace = require("./addFace");
...
var projectDataForm = document.querySelector('.form-project-data');
var faceDataForm = document.querySelector('.form-face-data');
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 7:
            document.querySelector('.btn--save-password').textContent = 'Сохранить пароль';
...
if (projectDataForm) projectDataForm.addEventListener('submit', /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(e) {
    var goalsArr, targetsArr, actionsArr, resultsArr, form, i, formLength, _i;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            goalsArr = document.getElementById('goals').value.split(';');
            targetsArr = document.getElementById('targets').value.split(';');
            actionsArr = document.getElementById('actions').value.split(';');
            ...
            formLength = document.getElementById('images').files.length;

            for (_i = 0; _i < formLength; _i++) {
...
if (faceDataForm) faceDataForm.addEventListener('submit', /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            e.preventDefault();
            document.getElementById('save').textContent = 'Сохранение...'; // const bestProjectsArr = document.getElementById('best').value.split(';');
            ...
            form.append('activity', document.getElementById('activity').value); // for (var i = 0; i < bestProjectsArr.length; i++) {
            ...
            _context3.next = 12;
            return (0, _addFace.addFace)(form);
